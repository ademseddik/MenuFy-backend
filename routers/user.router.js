...
/////////////////client//////////
router.put('/updatePasswordWeb',userController.updatePasswordWeb);
router.post('/sendSMSWeb', userController.sendSMSWeb);
router.post('/verifyCodeWeb', userController.verifyCodeWeb);
router.put('/updatePhoneWeb',userController.updatePhoneWeb);
