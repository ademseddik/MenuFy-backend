...
router.put('/increase/quantity/Cartweb/Trash/:userId/:productFK', _.increasequantityProductInCartTrash);
router.put('/decrease/quantity/Cartweb/Trash/:userId/:productFK', _.decreaseQuantityProductInCartTrash);
